...
//provides hints for Spring that the class plays a specific role. Our class is a web @Controller
//so Spring considers it when handling incoming web requests
@RestController
public class MainController {
    //annotation that provides "routing" info. Tells spring that any http request with "/",
    //path should be mapped to the home() method.
    @RequestMapping("/")
